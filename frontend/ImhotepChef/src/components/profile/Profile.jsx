...
const Profile = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50 bg-chef-pattern">
      {/* Floating decorative elements */}
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        <div className="absolute top-20 left-20 w-32 h-32 bg-purple-200 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-float"></div>
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        {/* Header Section */}
        <div className="chef-card rounded-3xl p-6 sm:p-8 lg:p-12 shadow-2xl border border-white/30 backdrop-blur-xl">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
            <div className="text-center sm:text-left">
              <div className="w-16 h-16 bg-chef-gradient rounded-full mb-4 shadow-lg flex items-center justify-center mx-auto sm:mx-0">
        ...
        {/* Tabs Navigation */}
        <div className="chef-card rounded-2xl p-2 shadow-lg border border-white/30 backdrop-blur-xl">
        ...
        {error && (
          <div className="chef-card rounded-2xl p-4 sm:p-6 shadow-lg border border-red-200 bg-red-50/80 backdrop-blur-xl">
        ...
        {success && (
          <div className="chef-card rounded-2xl p-4 sm:p-6 shadow-lg border border-green-200 bg-green-50/80 backdrop-blur-xl">
            <div className="flex items-center space-x-3">
              <div className="flex-shrink-0">
