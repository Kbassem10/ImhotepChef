...
const ResetPassword = () => {
  ...
  if (!isValidToken) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-red-50 via-rose-50 to-pink-50 bg-chef-pattern flex items-center justify-center p-4">
        {/* Floating decorative elements */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="relative w-full max-w-md">
          <div className="chef-card rounded-3xl p-8 shadow-2xl border border-white/30 backdrop-blur-xl text-center">
            ...
            <Link 
              to="/forgot-password" 
              className="chef-button bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-600 hover:to-pink-600 text-white w-full mb-4"
            >
      ...
      <div className="flex items-center justify-center min-h-screen p-4">
        ...
        <div className="chef-card rounded-3xl p-8 shadow-2xl border border-white/30 backdrop-blur-xl">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-white rounded-full mb-6 shadow-lg border border-gray-100">
              <img 
                src={ImhotepChefLogo} 
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="chef-button bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 text-white w-full disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
