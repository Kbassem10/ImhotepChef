const CACHE_NAME = 'imhotep-chef-v2';
...
const RUNTIME_CACHE = 'imhotep-chef-runtime-v1';
const API_CACHE = 'imhotep-chef-api-v1';
  ...
  return `
    ...
    <html>
      <head>
        ...
        <title>ImhotepChef - Offline</title>
      ...
      <body>
        <div class="offline-container">
          ...
          <p class="offline-message">
            ...
            ImhotepChef needs an active connection to generate new recipes, 
...
self.addEventListener('push', (event) => {
  ...
  event.waitUntil(
    self.registration.showNotification('ImhotepChef', options)
  );
});
